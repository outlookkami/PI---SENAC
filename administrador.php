...
if (isset($_POST['submit'])) {
    ...
    if ($stmt->execute()) {
        header("Location: administrador.php?msg=sucesso");
        exit;
    } else {
                        ...
                        <div class="ProximosEventos">
                            <table class="TableEventos">
                                ...
                                <td style="display: flex; justify-content: center; align-items: center; gap: 10px;">
                                    <a href="editar_evento.php?id_evento=<?php echo $row['id_evento']; ?>"><img class="editar" src="assets/edit.png" alt="Editar" style="cursor: pointer; width: 20px; height: 20px;"></a>
                                    <a href="deletar_evento.php?id_evento=<?php echo $row['id_evento']; ?>"><img class="deletar" src="assets/delete.png" alt="Deletar" style="cursor: pointer; width: 20px; height: 20px;"></a>
                                </td>
...
<form method="post" action="admPortal.php" enctype="multipart/form-data" class="CriarEventoForm"> -->
    ...
    <div class="CriarEventoForm" id="formCriarEvento" style="display: none;">
        <form method="post" action="administrador.php" enctype="multipart/form-data" class="CriarEventoForm">
            ...
            <div class="horarios">
                ...
                <div>
                    ...
                    <input class="inpt1" type="time" name="horario_fim_evento" id="horario_fim_evento" placeholder="Ex: 16:00">
                </div>
            </div>
    ...
    <style>
        ...
        * {
        ...
        @media screen and (max-width: 839px) {
            ...
            #CriarEventoForm input,
            #CriarEventoForm select,
            #CriarEventoForm button {
                font-size: 14px;
                padding: 8px;
            }
        }
